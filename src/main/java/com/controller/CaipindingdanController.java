...
public class CaipindingdanController {
    ...
    public R info(@PathVariable("id") Long id){
        ...
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(caipindingdan,deSens);
    ...
    public R save(@RequestBody CaipindingdanEntity caipindingdan, HttpServletRequest request){
        ...
        return R.ok().put("data",caipindingdan.getId());
    }
    ...
    public R update(@RequestBody CaipindingdanEntity caipindingdan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(caipindingdan);
        //全部更新
        caipindingdanService.updateById(caipindingdan);
        return R.ok();
    }
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) throws IOException {
        ...
        java.nio.file.Path path = java.nio.file.Paths.get("value_caipindingdan_" + xColumnName + "_" + yColumnName + "_timeType.json");
        ...
        EntityWrapper<CaipindingdanEntity> ew = new EntityWrapper<CaipindingdanEntity>();
            //获取结果
        List<Map<String, Object>> result = caipindingdanService.selectValue(params, ew);
    ...
    public R valueMul(@PathVariable("xColumnName") String xColumnName,@RequestParam String yColumnNameMul,HttpServletRequest request)  throws IOException {
        //读取文件，如果文件存在，则优先返回文件内容
        java.nio.file.Path path = java.nio.file.Paths.get("value_caipindingdan_" + xColumnName + "_" + yColumnNameMul + "_timeType.json");
        if(java.nio.file.Files.exists(path)) {
            String content = new String(java.nio.file.Files.readAllBytes(path), java.nio.charset.StandardCharsets.UTF_8);
            return R.ok().put("data", (new org.json.JSONArray(content)).toList());
        }
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) throws IOException {
        //读取文件，如果文件存在，则优先返回文件内容
        java.nio.file.Path path = java.nio.file.Paths.get("value_caipindingdan_" + xColumnName + "_" + yColumnName + "_"+timeStatType+".json");
        if(java.nio.file.Files.exists(path)) {
            String content = new String(java.nio.file.Files.readAllBytes(path), java.nio.charset.StandardCharsets.UTF_8);
            return R.ok().put("data", (new org.json.JSONArray(content)).toList());
        }
        ...
        //构建查询统计条件
        EntityWrapper<CaipindingdanEntity> ew = new EntityWrapper<CaipindingdanEntity>();
        List<Map<String, Object>> result = caipindingdanService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    {
        //读取文件，如果文件存在，则优先返回文件内容
        java.nio.file.Path path = java.nio.file.Paths.get("value_caipindingdan_" + xColumnName + "_" + yColumnNameMul + "_" + timeStatType + ".json");
        if (java.nio.file.Files.exists(path)) {
            String content = new String(java.nio.file.Files.readAllBytes(path), java.nio.charset.StandardCharsets.UTF_8);
            return R.ok().put("data", (new org.json.JSONArray(content)).toList());
        }
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) throws IOException {
        //读取文件，如果文件存在，则优先返回文件内容
        java.nio.file.Path path = java.nio.file.Paths.get("group_caipindingdan_" + columnName + "_timeType.json");
        if(java.nio.file.Files.exists(path)){
            String content = new String(java.nio.file.Files.readAllBytes(path), java.nio.charset.StandardCharsets.UTF_8);
            return R.ok().put("data", (new org.json.JSONArray(content)).toList());
        }
        ...
        //构建查询统计条件
        EntityWrapper<CaipindingdanEntity> ew = new EntityWrapper<CaipindingdanEntity>();
        List<Map<String, Object>> result = caipindingdanService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,CaipindingdanEntity caipindingdan, HttpServletRequest request){
        EntityWrapper<CaipindingdanEntity> ew = new EntityWrapper<CaipindingdanEntity>();
        int count = caipindingdanService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, caipindingdan), params), params));
