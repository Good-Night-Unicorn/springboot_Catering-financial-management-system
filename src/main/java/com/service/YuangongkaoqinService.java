...
public interface YuangongkaoqinService extends IService<YuangongkaoqinEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<YuangongkaoqinEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<YuangongkaoqinEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<YuangongkaoqinEntity> wrapper);


    List<Map<String, Object>> yuangongxingmingkaoqinleixingTypeStat(Map<String, Object> params,Wrapper<YuangongkaoqinEntity> wrapper);
