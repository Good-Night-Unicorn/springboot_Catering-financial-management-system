...
public interface CaipindingdanService extends IService<CaipindingdanEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<CaipindingdanEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<CaipindingdanEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<CaipindingdanEntity> wrapper);
