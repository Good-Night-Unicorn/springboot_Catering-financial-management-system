	...
	<div>
		<div class="register-container">
			...
			<el-form v-if="pageFlag=='register'" ref="ruleForm" class="rgs-form animate__animated animate__" :model="ruleForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于SpringBoot的餐饮财务管理系统的设计与实现</div>
					...
					<el-form-item class="list-item" v-if="tableName=='yuangong'">
						<div class="lable" :class="changeRules('yuangongshouji')?'required':''">员工手机：</div>
						<el-input  v-model="ruleForm.yuangongshouji"  autocomplete="off" placeholder="员工手机"  type="text"  />
					</el-form-item>
