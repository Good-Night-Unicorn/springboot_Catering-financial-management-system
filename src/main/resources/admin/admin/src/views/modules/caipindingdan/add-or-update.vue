	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="菜品编号" prop="caipinbianhao" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="餐桌号" prop="canzhuohao" >
					<el-input v-model="ruleForm.canzhuohao" placeholder="餐桌号" clearable  :readonly="ro.canzhuohao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="餐桌号" prop="canzhuohao" >
					<el-input v-model="ruleForm.canzhuohao" placeholder="餐桌号" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="下单备注" prop="xiadanbeizhu" >
					<el-input v-model="ruleForm.xiadanbeizhu" placeholder="下单备注" clearable  :readonly="ro.xiadanbeizhu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="下单备注" prop="xiadanbeizhu" >
					<el-input v-model="ruleForm.xiadanbeizhu" placeholder="下单备注" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-else-if="ruleForm.xiadanriqi" label="下单日期" prop="xiadanriqi" >
